...
class userLoginDTO {
    static _OPENAPI_METADATA_FACTORY() {
        return { email: { required: true, type: () => String }, password: { required: true, type: () => String, minLength: 6 }, role: { required: true, enum: require("../../../Utilities/Template/types").Roles } };
    }
}
...
__decorate([
    ...
    __metadata("design:type", String)
], userLoginDTO.prototype, "role", void 0);
