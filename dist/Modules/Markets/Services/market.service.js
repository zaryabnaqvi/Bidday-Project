...
let MarketService = class MarketService {
    ...
    async findAll() {
        try {
            ...
            if (Markets.length === 0) {
                throw new common_3.HttpException('Markets not found', common_2.HttpStatus.NOT_FOUND);
            }
            return {
                statusCode: common_2.HttpStatus.OK,
    ...
    async findOne(id) {
        try {
            ...
            if (!isMarketExist) {
                throw new common_3.HttpException('Market by Id not Found', common_2.HttpStatus.NOT_FOUND);
            }
            return {
                statusCode: common_2.HttpStatus.OK,
    ...
    async update(id, updateMarketDto) {
        if (Object.keys(updateMarketDto).length === 0) {
            throw new common_3.HttpException('Empty Body is not allowed', common_2.HttpStatus.NOT_ACCEPTABLE);
        }
